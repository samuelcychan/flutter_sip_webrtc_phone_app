...
class _RegisterWidgetState extends State<RegisterWidget>
  ...
  void loadFromStorage() {
    setState(() {
      ...
      _sipUriController.text = 'sip:${_authUserController.text}@172.24.245.50';
    });
  }
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: const UnderlineInputBorder(
                        borderSide: BorderSide(color: Colors.black12)),
                    hintText:
                        _authUserController.text.isEmpty ? '[Empty]' : null,
                  ),
                ),
              ),
              const Padding(
  ...
  void handleSave(BuildContext context) async {
    ...
    settings.registerParams.extraContactUriParams = <String, String>{
      'pn-platform':
          TargetPlatform.iOS == defaultTargetPlatform ? 'iOS' : 'Android',
      'app-id': (await PackageInfo.fromPlatform()).packageName,
      'pn-voip-tok': controller.token,
    };
    settings.uri = _sipUriController.text;
    controller.registeredDomain = _sipUriController.text.split('@').last;
