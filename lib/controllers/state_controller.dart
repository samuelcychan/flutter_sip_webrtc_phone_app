...
class StateController extends GetxController {
  ...
  final _registeredDomain =
      GetStorage().read('registered_domain')?.toString().obs ?? "".obs;
  set registeredDomain(String domain) {
    _registeredDomain.value = domain;
    update();
  }

  String get registeredDomain => _registeredDomain.value;
}
